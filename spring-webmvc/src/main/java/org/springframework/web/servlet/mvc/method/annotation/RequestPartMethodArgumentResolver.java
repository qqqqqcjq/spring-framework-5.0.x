 ...
 * @since 3.1
 */
//它用于解析被@RequestPart修饰的参数，或者参数类型是 MultipartFile或者Servlet 3.0提供的javax.servlet.http.Part类型（并且没有被@RequestParam修饰，@RequestParam也支持MultipartFile），数据通过 HttpServletRequest获取
