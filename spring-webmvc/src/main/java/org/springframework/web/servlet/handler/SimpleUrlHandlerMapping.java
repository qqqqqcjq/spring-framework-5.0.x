 ...
 * accepted by the {@code java.util.Properties} clas                               s, like as follows:<br>
 * {@code
...
public class SimpleUrlHandlerMapping extends AbstractUrlHandlerMapping {
	...
	/**
     * SimpleUrlHandlerMapping定义了一个Map变量urlMap，将所有的url和Handler的对应关系放在里面，最后注册到父类AbstractUrlHandlerMapping的handlermap中
     * （自己定义一个Map主要有两个作用，第一是方便配置，第二是可以在注册前做一些预处理，如确保所有url都以“/”开头）
