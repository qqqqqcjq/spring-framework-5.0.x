 ...
 * @since 3.1
 */
//扩展自AbstractMessageConverterMethodArgumentResolver，使用HttpMessageConverter处理hanler method的返回值
//虽然是AbstractMessageConverterMethodArgumentResolver的子类，但处理的是handle method的返回值
public abstract class AbstractMessageConverterMethodProcessor extends AbstractMessageConverterMethodArgumentResolver
	...
	protected <T> void writeWithMessageConverters(@Nullable T value, MethodParameter returnType,
        ...
        // 我们本例；outputValue为返回值对象  Person@5229
        ...
        // 若返回值是个org.springframework.core.io.Resource  就走这里
		...
		if (selectedMediaType != null) {
			...
			for (HttpMessageConverter<?> converter : this.messageConverters) {
				...
				if (genericConverter != null ?
				    ...
				    //里面也提供了ResponseBodyAdvice钩子，我们可以通过实现此接口，来对接口的返回值进行干预、修改。
                    //相关注解为：@ControllerAdvice、@RestControllerAdvice
