...
public abstract class AbstractDetectingUrlHandlerMapping extends AbstractUrlHandlerMapping {
	...
	protected void detectHandlers() throws BeansException {
		...
		for (String beanName : beanNames) {
            ...
            //AbstractDetectingUrlHandlerMapping有三个子类：BeanNameUrlHandlerMapping、Default-AnnotationHandlerMapping和AbstractControllerUrlHandlerMapping，
            //其中DefaultAnnotation-HandlerMapping已经标注了@Deprecated被弃用了，所以我们就不分析它了。
