 ...
 * @since 3.1
 */
//既可以处理@RequestBody修饰的参数，又可以处理@ResoponseBody修饰的方法的返回值，从继承关系上就可以看出
//用于解析被@RequestBody修饰的参数，resolveArgument()方法其实直接使用了父类AbstractMessageReaderArgumentResolver#readBody()方法
//也用于处理@ResoponseBody修饰的方法的返回值
public class RequestResponseBodyMethodProcessor extends AbstractMessageConverterMethodProcessor {
	...
	public void handleReturnValue(@Nullable Object returnValue, MethodParameter returnType,
        ...
        // 这里找到消息转换器HttpMessageConverter ，来把返回的结果写进response里面
