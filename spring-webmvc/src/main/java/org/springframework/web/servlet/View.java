 ...
 * This interface is designed to avoid restricting the range of possible implementations.ViewResolver
 *
 ...
 */
//顶层接口，有多种子类，比如AbstractFeedView AbstractJackson2View AbstractPdfView InternalResourceView等等很多子类，每一种子类都会作为一个单例bean又spring容器进行管理
//每一种view实例都会把model渲染到对应的html pdf xml json等等页面中
