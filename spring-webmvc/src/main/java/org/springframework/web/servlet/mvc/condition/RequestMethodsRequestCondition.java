...
public final class RequestMethodsRequestCondition extends AbstractRequestCondition<RequestMethodsRequestCondition> {
	...
	@Override
	@Nullable
    // 请求匹配RequestMethodsRequestCondition封装的RequestMethod(GET, HEAD, POST, PUT, PATCH, DELETE, OPTIONS, TRACE)才会返回一个RequestMethodsRequestCondition,否则返回null,
    // 只要有一个RequestCondition#getMatchingCondition返回null,
    // 就表示这个请求不能让这个RequestMappingInfo对应的HandlerMethod处理(注：一个RequestMappingInfo对应一个HandlerMethod)
