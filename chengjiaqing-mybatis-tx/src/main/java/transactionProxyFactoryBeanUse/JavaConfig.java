...
@ComponentScan("transactionProxyFactoryBeanUse")
@ComponentScan("dto")
//开启事务注解
...
//        sqlSessionFactoryBean.setConfiguration(configuration);
    ...
    //我们自己配置规则，生成代理类
    //这种方式我们直接使用TransactionProxyFactoryBean生成代理类，生成的规则我们可以设定，可以细化
    @Bean("userServiceProxy")
    public TransactionProxyFactoryBean transactionProxyFactoryBean(PlatformTransactionManager platformTransactionManager, UserService userService){
