...
public class UrlPathHelper {
	 ...
	 */
	//  URL查找是否应该在当前应用程序上下文中始终使用完整路径，例如在{@link ServletContext#getContextPath()}中。
    //  如果设置为{@literal false}，就不使用{@link ServletContext#getContextPath()}，使用当前servlet映射中的路径(例如，“/myServlet/*”)。
    //  默认设置为“false”。
	 ...
	 * @see WebUtils#DEFAULT_CHARACTER_ENCODING
	 */
	// 设置URL解码使用的默认字符编码，默认使用ISO-8859-1
