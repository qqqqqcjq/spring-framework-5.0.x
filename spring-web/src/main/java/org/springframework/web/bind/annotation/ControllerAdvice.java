...
/** ControllerAdivice注解的bean, 里面的方法如果被@Initbinder @ExceptionHandler  @ExceptionHandler  @ModelAttribute注解
 *  这些方法就是全局的，被所有的controller共用
 *
 * Specialization of {@link Component @Component} for classes that declare
 * {@link ExceptionHandler @ExceptionHandler}, {@link InitBinder @ExceptionHandler}, or
