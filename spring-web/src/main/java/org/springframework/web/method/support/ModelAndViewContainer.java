...
// 它除了保存Model和View外还有一些别的功能，如果不知道这些功能，很多代码就无法理解
public class ModelAndViewContainer {
    ...
    // 注意：ModelMap 只是个Map而已，但是实现类BindingAwareModelMap却实现了org.springframework.ui.Model接口
	...
	/**
     * 可以设置响应码，最终和ModelAndView一起被View渲染时候使用
    ...
    // 举个例子：比如@ResponseBody标注的方法，无需View继续去处理，所以就可以设置此值为true了
