...
public class SpringApplicationLuban {
    public static  void run() throws ServletException {
        ...
        System.out.println(new File("luban-springmvcboot/src/main/webapp").getAbsolutePath());
        //告訴tomcat你的源碼在哪裏
        Context ctx = tomcat.addWebapp("/luban-springmvcboot",new File("luban-springmvcboot/src/main/webapp").getAbsolutePath());
