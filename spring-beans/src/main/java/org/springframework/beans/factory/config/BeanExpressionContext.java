 ...
 * @since 3.0
 */
//用于对bean定义中的表达式求值的容器，所以里面肯定可以引用到PropertySources
//比如源码中这里的用法 ： StandardBeanExpressionResolver#evaluate(@Nullable String value, BeanExpressionContext evalContext)
