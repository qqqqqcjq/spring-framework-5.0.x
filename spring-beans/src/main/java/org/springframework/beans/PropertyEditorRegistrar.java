...
/**
 * 使用{@link org.springframework.beans.PropertyEditorRegistry}
 * 注册自定义的{@link java.beans.PropertyEditor property editors}属性编辑器
 ...
 *
 * 这是特别有用的，当你在不同的情况下需要使用相同的属性编辑器，写一个相应的注册商，并在每个情况下重用。
...
public interface PropertyEditorRegistrar {
     ...
     *
     * 传入的registry是BeanWrapper 或者 DataBinder(都实现了PropertyEditorRegistrar接口)
     ...
     *
     * 这个方法每次应该创建一个全新的PropertyEditors， 因为PropertyEditors并不是线程安全的
