 ...
 */
// spring 的7种事务传播机制有一种嵌套事务，嵌套事务使用的是savepoint，
// 需要底层数据库支持savepoint(保存点)，mysql就支持savepoint,具体可以参考石墨文档
//mysql> BEGIN;
//mysql> INSERT INTO Test VALUES(100);
//mysql> SAVEPOINT svp1;    ==>对应createSavepoint()方法
//mysql> INSERT INTO Test VALUES(200);
//mysql> ROLLBACK TO SAVEPOINT svp1; ==>对应rollbackToSavepoint(Object savepoint)方法
//mysql> RELEASE SAVEPOINT svp1;  ==>对应releaseSavepoint(Object savepoint)方法
//mysql> COMMIT;
