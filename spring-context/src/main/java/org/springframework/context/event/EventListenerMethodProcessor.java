	...
	protected void processBean(
		...
		if (!this.nonAnnotatedClasses.contains(targetType)) {
			...
			try {
                ...
                //inspect（Method method）方法：AnnotatedElementUtils.findMergedAnnotation(method, EventListener.class);判断方法是否有@EventListener注解。如果存在这样的注释，则返回指定类型的元素的注释，否则为null。
